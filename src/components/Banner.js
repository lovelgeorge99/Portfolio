...
function Banner() {
  let skills = [
    ...
    {
      name: "Java",
      icon: <img src={java}></img>,
      color: "text-red-500",
      size: "w-10",
    },
    {
      name: "Python3",
      icon: <img src={python}></img>,
    ...
    },
    {
      ...
      color: "text-blue-500",
      size: "text-2xl font-extrabold",
    },
    {
      name: "Redux",
      icon: <ion-icon name="logo-electron"></ion-icon>,
      color: "text-blue-800",
      size: "text-2xl",
    },
  ...
  return (
    <div className="p-10 bg-gray-100 ">
      <div className=" flex text-center flex-wrap-reverse justify-center items-center">
        <div className="">
          <h1 className="text-3xl  md:text-7xl md:font-bold   text-center  ">
            Hi, I am <span className=" text-[#00cdac]"> Lovel George</span>
          </h1>
        ...
        <div className="align-center">
          <img
            src={mypic}
            className=" rounded-full border border-black   md:inline-block w-56 md:w-72 m-24 md:text-3xl "
            alt="My  Pic"
          />
        </div>
      </div>
        ...
        <dl className="flex flex-wrap flex-row justify-center md:justify-start">
          ...
          {skills.map((skill) => (
            <div className="flex flex-col px-4 m-1 md:m-0 items-center justify-center">
              <dt
                className={`mb-2 ${skill.size} font-extrabold ${skill.color}`}
              >
                {skill.icon}
              </dt>
